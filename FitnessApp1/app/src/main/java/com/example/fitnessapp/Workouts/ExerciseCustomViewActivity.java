...
//    https://github.com/shrikanth7698/Collapsible-Calendar-View-Android - collapsible-calendar-view
    ...
    public ExerciseCustomViewActivity(String exerciseName, String whichActivity) {
        this.whichActivity = whichActivity;
        this.exerciseName = exerciseName;
    }

    public ExerciseCustomViewActivity() {
        ...
        btnAddHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(whichActivity.equals("Abs")) {
                    ...
                    userRef = mDB.getReference("Users/user_" + mAuth.getCurrentUser().getUid() + "/workouts/abs/"+exerciseName+"/"+date+"/1/exercise_weight");
                    userRef.setValue(currWeight);
                    userRef = mDB.getReference("Users/user_" + mAuth.getCurrentUser().getUid() + "/workouts/abs/"+exerciseName+"/"+date+"/1/exercise_repetition");
